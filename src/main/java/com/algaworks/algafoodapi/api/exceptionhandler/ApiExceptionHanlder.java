...
public class ApiExceptionHanlder extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleBindException(BindException ex, HttpHeaders headers, HttpStatus status,
        ...
        return handelValidationInternal(ex, headers, status, request, ex.getBindingResult());
    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage(MSG_GENERICA_CONSUMIDOR_FINAL)
                .build();
    ...
    public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
        ...
        Problem problem = createProblemBuilder(status, problemType, MSG_GENERICA_CONSUMIDOR_FINAL).build();
    ...
    private ResponseEntity<Object> handleInvalidFormatException(
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage("Valor informado está com o tipo inválido. Por favor, verifique e tente novamente.")
                .build();
    ...
    private ResponseEntity<Object> handleUnrecognizedPropertyException(
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage(detail + " Por favor, verifique e tente novamente.")
                .build();
    ...
    private ResponseEntity<Object> handleIgnoredPropertyException(
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage("Existem campos nesse cadastro não podem ser alterados. Por favor, verifique e tente novamente.")
                .build();
    ...
    private ResponseEntity<Object> handelValidationInternal(Exception ex, HttpHeaders headers, HttpStatus status,
                                                            WebRequest request, BindingResult bindingResult) {
        ProblemType problemType = ProblemType.DADOS_INVALIDOS;
        String detail = "Um ou mais campos estão inválidos. Faça o preenchimento correto e tente novamente.";

        List<Object> problemObjects = bindingResult.getAllErrors().stream()
                .map(objectError -> {
                    String mensage = messageSource.getMessage(objectError, LocaleContextHolder.getLocale());

...
public class TesteController {
    ...
    public List<Restaurante> listarPorNomeECozinhaNome(String nome, String cozinhaNome) {
        return restauranteRepository.findByNomeContainingAndCozinhaNome(nome, cozinhaNome);
    }
}
